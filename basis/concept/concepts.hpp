 ...
 *      BASIS_MAKE_BOOL_TRAIT(isAddable,
 ...
 *                            lhs + rhs,
 *
 *      BASIS_MAKE_BOOL_TRAIT(isCallable,
 ...
 */
#define BASIS_MAKE_BOOL_TRAIT(name, tpl_params, tpl_args, decls, /*exprs*/...) \
    template <BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>                  \
    BASIS_MAKE_BOOL_TRAIT_CONCEPTS_KEYWORD make_trait_impl_##name##_concept =  \
        requires(BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND decls) {                  \
        {__VA_ARGS__};                                                         \
    };                                                                         \
    template <BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>                  \
    constexpr inline bool name =                                               \
        make_trait_impl_##name##_concept<BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_args>
...
#define BASIS_MAKE_BOOL_TRAIT_CONCEPTS_KEYWORD concept bool
#else
#define BASIS_MAKE_BOOL_TRAIT_CONCEPTS_KEYWORD concept
#endif
...
#define BASIS_MAKE_BOOL_TRAIT(name, tpl_params, tpl_args, decls, /*exprs*/...)            \
    template <BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>                             \
    auto make_trait_impl_##name##_fn(BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND decls)           \
        ->decltype(__VA_ARGS__);                                                          \
                                                                                          \
    template <typename ALWAYS_VOID, BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>       \
    constexpr inline bool make_trait_impl_##name##_bool = false;                          \
                                                                                          \
    template <BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>                             \
    constexpr inline bool make_trait_impl_##name##_bool<                                  \
        std::void_t<decltype(                                                             \
            &make_trait_impl_##name##_fn<BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_args>)>, \
        BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_args> = true;                             \
                                                                                          \
    template <BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_params>                             \
    constexpr inline bool name =                                                          \
        make_trait_impl_##name##_bool<void, BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND tpl_args>

#endif

// Strips off wrapping parens used to group some arguments. Use *without* any parens.
#define BASIS_MAKE_BOOL_TRAIT_HELPER_EXPAND(...) __VA_ARGS__
