...
#include "basis/dependency_hierarchy/dependency_util.hpp"
...
TEST_F(DependencyUtilTest, FlattenCombined) {
  ...
  //      Q -> M
  //
  // (order of some elements does not matter)
  EXPECT_EQ(mapNames(flattenNestedDependencies(dependenciesCombined), NeedSortNames::kFalse)
