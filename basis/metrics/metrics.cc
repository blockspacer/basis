...
// under the License.
//
#include "basis/metrics/metrics.hpp" // IWYU pragma: associated
...
basis::Status MetricEntity::WriteForPrometheus(PrometheusWriter* writer,
...
basis::Status MetricRegistry::WriteForPrometheus(PrometheusWriter* writer,
                                                 const MetricPrometheusOptions& opts,
                                                 int metricsRetirementAgeMs) const {
  EntityMap entities;
  {
...
basis::Status MetricPrototypeRegistry::WriteForPrometheus(PrometheusWriter* writer,
                                                          int metricsRetirementAgeMs) const {
...
basis::Status StringGauge::WriteForPrometheus(
...
basis::Status Counter::WriteForPrometheus(
    PrometheusWriter* writer, MetricEntity::AttributeMap& attr,
    const MetricPrometheusOptions& opts,
    int metricsRetirementAgeMs) const {
  if (prototype_->level() < opts.level) {
...
basis::Status Histogram::WriteForPrometheus(
    PrometheusWriter* writer, MetricEntity::AttributeMap& attr,
    const MetricPrometheusOptions& opts,
    int metricsRetirementAgeMs) const {
  if (prototype_->level() < opts.level) {
