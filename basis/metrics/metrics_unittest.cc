...
TEST_F(MetricsTest, TestPrometheusWriter) {
  ...
  ASSERT_STR_CONTAINS(output.str(), "test_hist_sum{metric_id=\"my-test\",metric_type=\"test_entity\",exported_instance=\"DEFAULT_NODE_NAME\"} 5050");
  ASSERT_STR_CONTAINS(output.str(), "test_hist_count{metric_id=\"my-test\",metric_type=\"test_entity\",exported_instance=\"DEFAULT_NODE_NAME\"} 100");
}
