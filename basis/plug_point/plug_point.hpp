...
//
// Usually you want to use `::basis::StrongPlugPointRunner` (see below)
//
namespace basis {
...
{
 public:
  static_assert(basis::plug_point_internal::is_optional<RetType>::value,
