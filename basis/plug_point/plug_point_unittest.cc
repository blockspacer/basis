...
TEST_F(PlugPointVoidCallbacksTest, TestVoidPlugPointDisabledCallback) {
  ...
  PLUG_POINT(testPoint_)->addCallback(basis::PlugPointPriority::Low
          , base::BindRepeating(
          [
          ](
            const std::string& err_message
  ...
  PLUG_POINT(testPoint_)->addCallback(basis::PlugPointPriority::High
          , base::BindRepeating(
          [
          ](
            const std::string& err_message
...
TEST_F(PlugPointCallbacksTest, TestCallbacksPlugPointDisabledCallback) {
  ...
  > subscription1 = PLUG_POINT(testPoint_)->addCallback(basis::PlugPointPriority::Low
          , base::BindRepeating(
          [
          ](
            const std::string& err_message
  ...
  std::unique_ptr<
    PP_TestPointRunner::Subscription
  > subscription2 = PLUG_POINT(testPoint_)->addCallback(basis::PlugPointPriority::High
          , base::BindRepeating(
          [
          ](
            const std::string& err_message
