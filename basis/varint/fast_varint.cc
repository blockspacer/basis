...
#include "basis/varint/fast_varint.hpp" // IWYU pragma: associated
...
basis::StatusOr<DecodedSignedPair> FastDecodeSignedVarInt(const uint8_t* src, size_t src_size) {
...
basis::Status FastDecodeUnsignedVarInt(
...
basis::StatusOr<uint64_t> FastDecodeUnsignedVarInt(base::span<const uint8_t>* slice) {
