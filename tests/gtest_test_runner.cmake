...
add_library( ${gtest_test_runner} OBJECT
  ${CMAKE_CURRENT_SOURCE_DIR}/../basis/test/run_all_unittests.cc
)
...
target_compile_definitions( ${gtest_test_runner} PUBLIC
  BUILD_DATE=BASIS_BUILD_DATE
  USE_GTEST_TEST=1 )

macro(basis_test_gtest test_name source_list)
  ...
  basis_test("${test_name}" "${source_list}" "${GTEST_TEST_ARGS}" "${gtest_test_runner}")
endmacro()
